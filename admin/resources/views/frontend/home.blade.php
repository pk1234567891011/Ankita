...
<script src="{{ asset ('/jss/js/jquery.js')}}"></script>
	<script src="{{ asset ('/jss/jss/js/bootstrap.min.js')}}"></script>
	<script src="{{ asset ('/jss/jss/js/jquery.scrollUp.min.js')}}"></script>
	<script src="{{ asset ('/jss/jss/js/price-range.js')}}"></script>
    <script src="{{ asset ('/jss/jss/js/jquery.prettyPhoto.js')}}"></script>
    <script src="{{ asset ('/jss/jss/js/main.js')}}"></script>
</html>