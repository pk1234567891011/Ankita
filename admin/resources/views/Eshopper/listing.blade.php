  ...
  <section>
        ...
        <div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">{{$categorys->name}}</h2>
                        ...
                        <div class="col-sm-4">
							...
							<div class="product-image-wrapper">
								...
								<div class="single-products">
										...
										<img src="{{ URL::to('/') }}/products/{{ $images->image_name }}" height="100px"
	    	>
										...
										<div class="product-overlay">
											<div class="overlay-content">
												<h2>INR {{$products->price}}</h2>
												<p>{{$products->name}}</p>
												<a href="{{url('prod/'.$products->id )}}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
											</div>
										</div>
								</div>
								<div class="choose">
